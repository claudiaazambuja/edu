...
export const WHATSAPP_DEFAULT_MESSAGE =
  'Olá! Quero iniciar uma jornada educacional com base forte para meu filho(a), com uma experiência de aprendizagem acolhedora em leitura, escrita e matemática. Podemos conversar?';
